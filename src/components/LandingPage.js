          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            {savedEmail ? (
              <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/login" className="ios-glass glass-btn" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", textDecoration: "none", padding: "16px 36px", fontSize: "16px", color: "var(--bg)", background: "var(--ink)", fontWeight: 600, borderRadius: "99px" }}>
              ...
              <>
                <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
                  {/* Tlačítko pro klasickou registraci */}
                  <Link href="/register" className="glass-btn ios-glass" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", textDecoration: "none", padding: "16px 36px", fontSize: "16px", color: "var(--bg)", background: "var(--ink)", fontWeight: 600, borderRadius: "99px" }}>
                    Založit účet e-mailem
                  </Link>

                  {/* Luxusní tlačítko pro Google přihlášení */}
                  <button onClick={() => signIn('google')} className="glass-btn ios-glass" style={{ display: "inline-flex", alignItems: "center", gap: "12px", justifyContent: "center", border: "1px solid rgba(255,255,255,0.25)", cursor: "pointer", padding: "16px 36px", fontSize: "16px", color: "var(--ink)", background: "rgba(255,255,255,0.05)", fontWeight: 600, borderRadius: "99px" }}>
                ...
                {/* Odkaz na klasické přihlášení, pokud už má účet */}
                <div style={{ marginTop: "24px", fontSize: "14px", color: "var(--ink-dim)" }}>
                  Již máte účet? <Link href="/login" style={{ color: "var(--ink)", fontWeight: 600, textDecoration: "none", borderBottom: "1px solid rgba(255,255,255,0.5)", paddingBottom: "2px", transition: "border-color 0.2s" }} onMouseOver={e => e.target.style.borderColor = 'var(--ink)'} onMouseOut={e => e.target.style.borderColor = 'rgba(255,255,255,0.5)'}>Přihlásit se</Link>
                </div>
              </>
            )}
          </div>
